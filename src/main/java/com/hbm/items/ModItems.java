...
public class ModItems {
	...
	private static void registerItem() {
		...
		registerItemSafe(gun_pepperbox);
		registerItemSafe(gun_light_revolver);
		registerItemSafe(gun_light_revolver_atlas);
		registerItemSafe(gun_light_revolver_dani);
		registerItemSafe(gun_henry);
		registerItemSafe(gun_henry_lincoln);
		registerItemSafe(gun_greasegun);
		registerItemSafe(gun_maresleg);
		registerItemSafe(gun_maresleg_akimbo);
		registerItemSafe(gun_maresleg_broken);
		registerItemSafe(gun_flaregun);
		registerItemSafe(gun_heavy_revolver);
		registerItemSafe(gun_heavy_revolver_lilmac);
		registerItemSafe(gun_heavy_revolver_protege);
		registerItemSafe(gun_carbine);
		registerItemSafe(gun_am180);
		registerItemSafe(gun_liberator);
		registerItemSafe(gun_congolake);
		registerItemSafe(gun_flamer);
		registerItemSafe(gun_flamer_topaz);
		registerItemSafe(gun_flamer_daybreaker);
		registerItemSafe(gun_uzi);
		registerItemSafe(gun_uzi_akimbo);
		registerItemSafe(gun_spas12);
		registerItemSafe(gun_panzerschreck);
		registerItemSafe(gun_star_f);
		...
		registerItemSafe(gun_amat_subtlety);
		registerItemSafe(gun_amat_penance);
		registerItemSafe(gun_m2);
		registerItemSafe(gun_autoshotgun);
		registerItemSafe(gun_autoshotgun_shredder);
		registerItemSafe(gun_autoshotgun_sexy);
		registerItemSafe(gun_autoshotgun_heretic);
		registerItemSafe(gun_quadro);
		registerItemSafe(gun_lag);
		registerItemSafe(gun_minigun);
		registerItemSafe(gun_minigun_dual);
		registerItemSafe(gun_minigun_lacunae);
		registerItemSafe(gun_missile_launcher);
		registerItemSafe(gun_tesla_cannon);
		registerItemSafe(gun_laser_pistol);
		registerItemSafe(gun_laser_pistol_pew_pew);
		registerItemSafe(gun_laser_pistol_morning_glory);
		registerItemSafe(gun_stg77);
		registerItemSafe(gun_tau);
		registerItemSafe(gun_fatman);
		registerItemSafe(gun_lasrifle);
		registerItemSafe(gun_coilgun);
		registerItemSafe(gun_hangman);
		registerItemSafe(gun_mas36);
		registerItemSafe(gun_bolter);
		registerItemSafe(gun_folly);
		registerItemSafe(gun_aberrator);
		registerItemSafe(gun_aberrator_eott);
		registerItemSafe(gun_double_barrel);
		registerItemSafe(gun_double_barrel_sacred_dragon);
		registerItemSafe(gun_n_i_4_n_i);

		registerItemSafe(gun_fireext);
		registerItemSafe(gun_charge_thrower);
		registerItemSafe(gun_drill);

		registerItemSafe(ammo_standard);
		registerItemSafe(ammo_secret);

		registerItemSafe(weapon_mod_test);
		registerItemSafe(weapon_mod_generic);
		registerItemSafe(weapon_mod_special);
		registerItemSafe(weapon_mod_caliber);
		...
		//Money
		registerItemSafe(cap_nuka);
		registerItemSafe(cap_quantum);
		registerItemSafe(cap_sparkle);
		registerItemSafe(cap_rad);
		registerItemSafe(cap_korl);
		registerItemSafe(cap_fritz);
		registerItemSafe(ring_pull);
		registerItemSafe(can_key);
		registerItemSafe(coin_creeper);
		registerItemSafe(coin_radiation);
		registerItemSafe(coin_maskman);
		registerItemSafe(coin_worm);
		registerItemSafe(coin_ufo);
		registerItemSafe(medal_liquidator);
		registerItemSafe(bottled_cloud);
		registerItemSafe(protection_charm);
		registerItemSafe(meteor_charm);
		registerItemSafe(neutrino_lens);
		registerItemSafe(gas_tester);
		registerItemSafe(defuser_gold);
		registerItemSafe(ballistic_gauntlet);
		registerItemSafe(night_vision);
		registerItemSafe(card_aos);
		registerItemSafe(card_qos);
		registerItemSafe(australium_iii);
		registerItemSafe(armor_battery);
		registerItemSafe(armor_battery_mk2);
		registerItemSafe(armor_battery_mk3);
