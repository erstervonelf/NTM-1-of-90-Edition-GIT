# 1of90 Edition – Entwicklungs- und Erweiterungsdokumentation

Dieses Paket (`com.oneof90`) bildet einen klar abgegrenzten Erweiterungsraum für neue Inhalte (Blöcke, Maschinen, Multiblocks, Renderlogik) ohne direkte Modifikation des ursprünglichen HBM‑Codes. Ziel: Konfliktarme Weiterentwicklung, saubere Trennung, schnelle Wartung.
...
---
## 15. Weiterführende Detaildokumente
- **MACHINE_CREATION_GUIDE.md** – Schritt für Schritt Maschinen & Multiblocks
- **QUICK_REFERENCE.md** – Schnelles Nachschlagen (Metadaten, Patterns)
- **(Geplant)** ARCHITECTURE.md – Tiefere Diagramme & Abhängigkeiten
- **(Geplant)** API.md – Auflistung öffentlicher Schnittstellen & Beispiele
- **(Geplant)** MULTIBLOCKS.md – Vertiefung zu Strukturlogik & Varianten
- **(Geplant)** RENDERING.md – Modell-/Texturnutzung, Optimierung
- **(Geplant)** RESOURCES.md – Asset-Organisation & Tools
- **(Geplant)** TROUBLESHOOTING.md – Erweiterte Fehleranalyse
...
## Vorteile
- Keine direkte Änderung am HBM-Core
- Hohe Update-Freundlichkeit
- Saubere Verantwortlichkeit & Trennung
